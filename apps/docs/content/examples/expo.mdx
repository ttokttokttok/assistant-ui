...
catalog: { id: expo, kind: example, category: { id: mobile, name: Mobile }, tags: [React Native, Example], prompt: Open the Expo React Native example., gradient: from-violet-500/40 via-purple-500/30 to-fuchsia-400/20, image: /screenshot/examples/expo.png, sourcePath: examples/with-expo, preview: { status: stale, url: /xulux-preview/expo }, tech: { framework: Expo, runtime: React Native, frontendPattern: Mobile chat }, env: [], capabilities: { openInChat: true, agentProfile: expo } }
---
