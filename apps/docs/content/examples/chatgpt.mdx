...
catalog: { id: chatgpt, kind: example, category: { id: chat, name: Chat }, tags: [assistant-ui, ChatGPT, clone, chat], prompt: Open the ChatGPT Style Assistant demo., gradient: from-emerald-500/35 via-zinc-400/25 to-neutral-300/20, preview: { status: live, url: /xulux-preview/chatgpt }, tech: { framework: React, runtime: assistant-ui, frontendPattern: Chat clone }, env: [], capabilities: { openInChat: true, downloadProfile: demo-chatgpt, agentProfile: demo-chatgpt } }
---
