...
catalog: { id: gemini, kind: example, category: { id: chat, name: Chat }, tags: [assistant-ui, Gemini, clone, chat], prompt: Open the Gemini Style Assistant demo., gradient: from-blue-500/35 via-sky-300/25 to-rose-300/20, preview: { status: live, url: /xulux-preview/gemini }, tech: { framework: React, runtime: assistant-ui, frontendPattern: Chat clone }, env: [], capabilities: { openInChat: true, downloadProfile: demo-gemini, agentProfile: demo-gemini } }
---
