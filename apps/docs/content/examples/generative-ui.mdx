...
catalog: { id: generative-ui, kind: example, category: { id: ui-patterns, name: UI Patterns }, tags: [Generative UI, Example], prompt: Open the generative UI example., gradient: from-emerald-500/40 via-teal-500/30 to-cyan-400/20, preview: { status: live, url: /xulux-preview/generative-ui }, tech: { framework: Next.js, runtime: AI SDK, frontendPattern: Generative UI }, env: [], capabilities: { openInChat: true, agentProfile: generative-ui } }
---
