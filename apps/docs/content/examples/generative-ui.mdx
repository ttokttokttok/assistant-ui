...
catalog: { id: generative-ui, kind: example, order: 12, category: { id: ui-patterns, name: UI Patterns }, tags: [Generative UI, Example], prompt: Open the generative UI example., gradient: from-emerald-500/40 via-teal-500/30 to-cyan-400/20, image: /screenshot/examples/generative-ui.png, examplesCard: { title: Generative UI, description: "The model composes cards, facts, and charts at runtime through the present tool.", image: /screenshot/examples/generative-ui.png }, sourcePath: examples/with-generative-ui, preview: { status: live, url: /xulux-preview/generative-ui }, tech: { framework: Next.js, runtime: AI SDK, frontendPattern: Generative UI }, env: [], capabilities: { openInChat: true, agentProfile: generative-ui } }
---
