...
catalog: { id: mem0, kind: example, category: { id: chat, name: Chat }, tags: [Example], prompt: Open the Mem0 memory chat example., gradient: from-cyan-500/40 via-sky-500/30 to-blue-400/20, preview: { status: stale, url: /xulux-preview/mem0 }, tech: { framework: React, runtime: Mem0, frontendPattern: Memory chat }, env: [], capabilities: { openInChat: true, agentProfile: mem0 } }
---
