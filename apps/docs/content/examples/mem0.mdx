...
catalog: { id: mem0, kind: example, order: 8, category: { id: chat, name: Chat }, tags: [Example], prompt: Open the Mem0 memory chat example., gradient: from-cyan-500/40 via-sky-500/30 to-blue-400/20, image: /screenshot/examples/mem0.png, examplesCard: { title: Mem0 - ChatGPT with memory, description: "A personalized AI chat app powered by Mem0 that remembers your preferences, facts, and memories.", image: /screenshot/examples/mem0.png }, sourcePath: https://github.com/mem0ai/mem0/blob/main/examples/mem0-demo/components/assistant-ui/thread.tsx, preview: { status: stale, url: /xulux-preview/mem0 }, tech: { framework: React, runtime: Mem0, frontendPattern: Memory chat }, env: [], capabilities: { openInChat: true, agentProfile: mem0 } }
---
