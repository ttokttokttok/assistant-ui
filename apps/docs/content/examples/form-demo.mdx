...
catalog: { id: form-demo, kind: example, category: { id: ui-patterns, name: UI Patterns }, tags: [Forms, Example], prompt: Open the form-filling copilot example., gradient: from-violet-500/40 via-purple-500/30 to-fuchsia-400/20, image: /screenshot/examples/form-demo.png, sourcePath: examples/with-react-hook-form/app/page.tsx, preview: { status: live, url: /xulux-preview/form-demo }, tech: { framework: Next.js, runtime: AI SDK, frontendPattern: Frontend tools }, env: [], capabilities: { openInChat: true, agentProfile: form-demo } }
---
