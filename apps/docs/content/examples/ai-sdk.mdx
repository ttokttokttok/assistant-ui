...
catalog: { id: ai-sdk, kind: example, order: 7, category: { id: chat, name: Chat }, tags: [AI SDK, Example], prompt: Open the AI SDK chat persistence example., gradient: from-cyan-500/40 via-sky-500/30 to-blue-400/20, image: /screenshot/examples/ai-sdk.png, examplesCard: { title: AI SDK, description: Chat persistence with AI SDK., image: /screenshot/examples/ai-sdk.png }, sourcePath: apps/docs/components/examples/base.tsx, preview: { status: live, url: /xulux-preview/ai-sdk }, tech: { framework: Next.js, runtime: AI SDK, frontendPattern: Thread + Composer }, env: [], capabilities: { openInChat: true, agentProfile: ai-sdk } }
---
