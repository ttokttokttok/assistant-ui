...
catalog: { id: stockbroker, kind: example, category: { id: agents, name: Agents }, tags: [LangGraph, Example], prompt: Open the LangGraph stockbroker example., gradient: from-slate-500/40 via-zinc-500/30 to-neutral-400/20, image: /screenshot/stockbroker.png, examplesCard: { title: LangGraph Stockbroker, description: A stockbroker showing human in the loop with LangGraph, image: /screenshot/stockbroker.png }, sourcePath: https://github.com/assistant-ui/assistant-ui-stockbroker, preview: { status: stale, url: /xulux-preview/stockbroker }, tech: { framework: React, runtime: LangGraph, frontendPattern: Human-in-the-loop }, env: [], capabilities: { openInChat: true, agentProfile: stockbroker } }
---
