...
catalog: { id: perplexity, kind: example, category: { id: chat, name: Chat }, tags: [assistant-ui, Perplexity, clone, search], prompt: Open the Perplexity Style Assistant demo., gradient: from-teal-500/35 via-cyan-300/25 to-zinc-200/20, preview: { status: live, url: /xulux-preview/perplexity }, tech: { framework: React, runtime: assistant-ui, frontendPattern: Search assistant }, env: [], capabilities: { openInChat: true, downloadProfile: demo-perplexity, agentProfile: demo-perplexity } }
---
