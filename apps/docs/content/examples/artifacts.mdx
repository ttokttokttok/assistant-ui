...
catalog: { id: artifacts, kind: example, category: { id: ui-patterns, name: UI Patterns }, tags: [Artifacts, Example], prompt: Open the Claude Artifacts example., gradient: from-cyan-500/40 via-sky-500/30 to-blue-400/20, preview: { status: live, url: /xulux-preview/artifacts }, tech: { framework: Next.js, runtime: AI SDK, frontendPattern: Artifacts }, env: [], capabilities: { openInChat: true, agentProfile: artifacts } }
---
