...
catalog: { id: grok, kind: example, category: { id: chat, name: Chat }, tags: [assistant-ui, Grok, clone, chat], prompt: Open the Grok Style Assistant demo., gradient: from-neutral-700/35 via-zinc-500/25 to-cyan-300/20, preview: { status: live, url: /xulux-preview/grok }, tech: { framework: React, runtime: assistant-ui, frontendPattern: Chat clone }, env: [], capabilities: { openInChat: true, downloadProfile: demo-grok, agentProfile: demo-grok } }
---
