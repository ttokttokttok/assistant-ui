...
catalog: { id: claude, kind: example, category: { id: chat, name: Chat }, tags: [assistant-ui, Claude, clone, chat], prompt: Open the Claude Style Assistant demo., gradient: from-orange-400/35 via-stone-300/25 to-zinc-200/20, preview: { status: live, url: /xulux-preview/claude }, tech: { framework: React, runtime: assistant-ui, frontendPattern: Chat clone }, env: [], capabilities: { openInChat: true, downloadProfile: demo-claude, agentProfile: demo-claude } }
---
